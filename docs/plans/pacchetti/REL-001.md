...
> **In attesa — non è il pacchetto attivo.** Il 24 settembre 2026 il PO ha chiesto di partire dai
> simboli (**I-126**): il pacchetto attivo è `REL-003`, e questo viene dopo. Il testo qui sotto è
> quello scritto la notte del 24 settembre, quando era attivo, e si riattiva così com'è: cambiano
> soltanto la base — `main` dopo la fusione di `REL-003` — e il metro della suite, che si rimisura.
> La tavola di prova di `REL-003`, un impianto che non è fra i cinque, può fare da impianto nuovo
> al punto 5.
>
...
**Stato:** **IN ATTESA** (I-126). Era attivo dopo la fusione di `DRAW-018` (PR **#57**, tavole
approvate con **I-119**).
**Base:** `main` dopo la fusione di `REL-003`.
