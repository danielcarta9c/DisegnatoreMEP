...
> mentre `REL-003` continua sull'altro ramo; `REL-001` resta dopo, in
> `docs/plans/pacchetti/REL-001.md`. Il cartiglio non ha aspettato le domande della skill: «Capire»
