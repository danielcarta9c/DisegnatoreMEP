...
4. `2026-08-04-layout-routing-multitavola-plan.md` - layout, instradamento e multi-tavola. **Scritto, in attesa di approvazione del PM**: leggerlo per intero, a partire dal §0, che raccoglie le tre decisioni di prodotto da confermare prima di eseguire.
