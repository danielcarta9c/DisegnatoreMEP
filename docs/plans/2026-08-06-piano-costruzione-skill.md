...
| **B ter — le correzioni alle istruzioni dell'interprete** | Orchestratore | **applicate; la prova in camera pulita resta dovuta** | 2026-08-07 | Tredici correzioni, tutte gia' elencate dal verdetto del collaudo e dal verbale della prova. **Le due che avevano fatto respingere:** sciolta la contraddizione sul caso dei tre circuiti — l'esempio che diceva «il terzo non si disegna» e' stato tolto, e al suo posto c'e' la **regola generale dei raccordi a N vie** (dove N tubazioni si incontrano servono N−1 raccordi, in tutte le direzioni: macchine in parallelo, circuiti che partono da un punto, ritorni che rientrano sullo stesso attacco); sostituiti gli **esempi che ricalcavano le assunzioni delle letture manuali** con casi estranei — la somiglianza massima fra un esempio e una soluzione reale scende dal quasi-verbatim al 48%. **Il tipo C**, nuovo: si **chiede** solo quando il testo tace, le due strade sono entrambe corrette e la scelta cambia il disegno; sotto, si chiude e si dichiara. **Il regime** (§4.6): si ricava sommando le potenze dei generatori, non si chiede; se il testo non le da', si omette il campo e si scrive la domanda. Piu' le sette del verbale (comando di validazione compatibile con la camera pulita, nomi commerciali e qualifiche nelle proprieta', aggettivo che aggiunge un mestiere, posizione convenzionale del circolatore, raffrescamento senza fluido proprio, esclusioni esplicite come informazione, `project_id`) e la lista di controllo finale sulle quattro cose che decidono. Tre prove nuove inchiodano cio' che e' verificabile: l'esempio del §3 carica, dichiara il regime coerente con la potenza che scrive, e nessun esempio somiglia a una soluzione dei testi di prova oltre il 60%. **Per D-083 il pezzo 1 non e' «fatto»**: le istruzioni sono cambiate, quindi la prova in camera pulita va rifatta da capo con agenti nuovi e consegne conservate, e poi ricollaudata. |
| **B bis — cosa l'interprete deve capire, contato sulle regole** | Orchestratore, su indicazione del PM | **materiale pronto per il giro di correzioni del pezzo 1** | 2026-08-07 | Il PM: «ci sono dei trigger nelle regole che spostano la scelta da una parte all'altra — se c'e' o no l'ACS, se quel generatore produce ACS integrato, se la centrale e' sopra o sotto i 35 kW... non sono tanti. Se l'interprete non li ha capiti, quelle cose me le deve chiedere». Censite le condizioni delle diciassette regole, una per una: quattro famiglie di dato decidono tutto — che macchina e' ciascun pezzo (17 regole su 17, attraverso proprieta' e mestieri che la voce di catalogo porta con se'), che acqua porta ogni circuito (9), il regime (5), come i circuiti toccano una riserva (6). L'elenco e' in `skill/capire/COSA_DECIDE.md`, insieme al criterio delle tre condizioni per cui una cosa non decisa si **chiede** invece di essere dichiarata come assunzione. Entra nel giro di correzioni del pezzo 1: le istruzioni non si toccano fuori da quel giro, perche' ogni modifica impone una prova nuova in camera pulita. |
| **E bis — la camminata del ritorno generale si apre sui rami** | Orchestratore, su rilievo del PM | **corretto** | 2026-08-07 | Il PM, leggendo il confronto: «in che senso l'ibrido non ha il ritorno?». Aveva ragione, ed era un difetto mio: il ritorno generale dell'ibrido **c'e'** — e' il tratto fra il volume tecnico e la ripartizione verso le due macchine, e ci passa tutta l'acqua che torna dall'impianto. La camminata all'indietro si fermava sulla prima confluenza (dove rientra il ramo del sanitario) invece di aprirsi sui rami, e dichiarava quattro punti aperti su un impianto che il punto lo aveva. Ora la camminata esplora tutti i rami a monte, in ordine di scoperta e a parita' per identificativo di tubazione: l'ibrido riceve il corredo sul suo ritorno generale, i cinque impianti non hanno piu' punti aperti, e il caso vero di «tratto comune inesistente» (due anelli separati sulla stessa rete) resta punto aperto come deve. **Il rilievo del PM ha corretto anche un errore di metodo mio, piu' grave del difetto**: gli avevo girato come domande due cose che erano mie da risolvere (la posizione del corredo nell'ibrido) o gia' decise da lui (la filtrazione), e su una sua domanda retorica — «io voglio il filtro?» — stavo per scrivere una regola che mette il filtro a Y sull'acqua calda sanitaria domestica, dove non ci va. Ritirata prima di scriverla. Il confronto per il PM e' stato riscritto sui numeri veri e senza le due false domande. |
| **E — il regime della centrale e il tratto comune (D-106)** | Orchestratore (deviazione registrata sopra) | **sviluppato; collaudo a contesto separato in corso** | 2026-08-07 | Primo passo: il riscontro sugli schemi Caleffi, riga per riga con le citazioni, in coda alla parte terza del documento delle posizioni (criterio 1). Poi: il regime come dato dichiarato del modello, mai calcolato, col corredo minimo come default; l'ancoraggio del tratto comune («sul ritorno generale, a monte della prima ripartizione», e lo speculare sulla mandata) trovato camminando sulla struttura dai generatori, con il punto aperto dove il tratto non esiste; le regole aggiornate come dato secondo l'audit — corredo sul ritorno generale, defangatore uno per circuito, filtro a Y per generatore e fuori dai circolatori, termometro e sicurezza per generatore solo sopra i 35 kW, sfogo e sicurezza sul serbatoio sotto; il bordo macchina dichiarato dal catalogo (criterio 4). **Il vaso sanitario esce dalla regola del vaso di riscaldamento** e prende la sua regola sull'alimentazione della riserva: il verdetto di G3 le voleva unite, ma il tratto comune e' un posizionamento che la riserva sanitaria non puo' condividere, e la separazione discende dall'audit approvato — registrata qui. Due difetti d'ordine trovati dalle prove di regressione durante lo sviluppo e chiusi alla radice (la classificazione dei blocchi dell'assemblatore sul capofila; la soddisfazione che attraversava i raccordi a tre vie scegliendo dall'ordine del file). I serbatoi tecnici dichiarano di temere la sovrapressione, come il bollitore gia' faceva. Cinque grafi rigenerati e messi a confronto per il PM. |
| **C2 — lo scarico del bollitore sull'ingresso freddo** | Orchestratore | **corretto**, prova del collaudo tornata verde senza ammorbidirla | 2026-08-07 | Eseguito il progetto dell'appendice: il catalogo dichiara **da quale attacco la riserva si riempie** (il bollitore dall'ingresso freddo, come i costruttori lo documentano; il volano tecnico non dichiara niente perche' si riempie dal circuito), e la regola dello scarico posa la derivazione li' — dove la riserva si riempie, da li' si svuota. Il generatore delle fixture e' stato modificato e **rieseguito**, mai i file a mano. La stessa dichiarazione ha chiuso un allargamento indebito che il confronto dei grafi aveva appena scoperto: il corredo sanitario di alimentazione (gruppo di sicurezza, ritegno, vaso della riserva) si reggeva sulla coincidenza «teme la sovrapressione + tocca l'acqua fredda», e con la proprieta' nuova dei serbatoi tecnici sarebbe scattato anche sull'accumulo combinato, che dall'acqua fredda non riempie la riserva ma un serpentino istantaneo. Ora quelle tre regole chiedono che la rete sia **quella da cui la riserva dichiara di riempirsi**, e il corredo va solo a chi spetta. Un accessorio a stacco senza attacco dedicato, su una riserva che dichiara il punto di riempimento, si salda **solo li'**: mai piu' sull'uscita calda. |
...
| **E — collaudo indipendente del pacchetto E e di C2** | Collaudo a contesto separato | **RESPINTO** al primo giro · **quattro difetti corretti lo stesso giorno**, verdi sulle prove del collaudo adottate come regressione | 2026-08-07 | Il collaudo ha confermato con prove proprie il nucleo del pacchetto: regime dichiarato e mai calcolato (scansione del codice: nessun punto somma potenze; 500 kW scritti nelle proprieta' non muovono nulla; cinque impianti per tre dichiarazioni senza mai un misto), tratto comune deterministico su permutazioni congiunte e sull'inversione alfabetica di tutti i file delle regole, punti aperti dove il tratto non esiste, C2 chiusa senza ammorbidire la prova (verificato sul diff della storia), grafi rigenerabili byte per byte e confronto veritiero nei numeri. Ha respinto su **quattro difetti veri**: **(1)** il bordo macchina non faceva tacere le regole con soddisfazione per attacco — filtrazione, termometro, sicurezza o sfogo dichiarati a bordo venivano aggiunti lo stesso; **(2)** il rovescio, il piu' grave: per le regole di rete contava il bordo di **qualsiasi** membro, e la sicurezza dichiarata a bordo della pompa di calore faceva sparire in silenzio la sicurezza del serbatoio; **(3)** il vaso sanitario dell'impianto 3 firmato dalla regola del circuito chiuso — pezzo e posizione giusti, tracciabilita' e motivazione false nel dossier (D-039, D-085) — perche' lo scaldacqua dichiara anche il mestiere di generatore e la regola arrivava prima in alfabeto; **(4)** una fonte affermata oltre il riscontro sulla regola del vaso sanitario (D-103). **Correzioni, verdi sulle prove del collaudo**: il bordo soddisfa i bisogni ancorati a chi lo porta, in ogni ambito, e una regola di rete tace solo se **ogni** suo ancoraggio porta la funzione a bordo — mai per il bordo altrui; la regola del vaso di circuito dichiara il fluido di riscaldamento, cosi' sull'alimentazione della riserva firma la regola giusta; la fonte corretta sul riscontro documentato (Rehau). I quattro segni di difetto atteso sono stati tolti dalle prove adottate: da qui in poi sono regressione. Quattro osservazioni non bloccanti a rapporto, fra cui la filtrazione del secondario con scambiatore (dichiarata al PM nel confronto, senza regola finche' non la decide) e il ramo silenzioso della camminata del tratto comune, da chiudere al prossimo intervento sul file. |
| **A — collaudo indipendente dell'indirizzo dei nodi (D-105)** | Collaudo a contesto separato (secondo tentativo: il primo e' morto per limite di spesa senza lasciare nulla) | **APPROVATO** | 2026-08-07 | Giudicata la punta del ramo (architettura di D-105, mai toccata dai pacchetti successivi), con 91 prove proprie piu' dure delle consegnate, adottate come regressione. Esiti: la famiglia si legge solo dalla tabella di dati (ribattezzata una famiglia gli indirizzi seguono; tolta una voce la generazione ferma nominando fluido, mestiere e verso; sigle di fantasia non muovono nulla); stessi indirizzi su permutazioni combinate di tubazioni, pezzi e reti con semi diversi da quelli di sviluppo, su tutti e sei gli impianti, confrontando il dump completo e perfino il documento intero attraverso l'intera catena; innesti e diramazioni verificati strutturalmente (la principale non si spezza mai, la secondaria muore su un nodo altrui, i rami portano la lettera consecutiva) e pinnati sulla cascata di tre e sulla deviatrice; stacchi come civici con grammatica e unicita'; sigle identiche prima e dopo la lettura delle linee; documento conforme (da→a esatti, civici sotto il nodo, anelli dove la struttura li ha, niente identificativi ne' inglese); documenti pubblicati uguali alla rigenerazione corrente. Quattro osservazioni non bloccanti registrate nel rapporto, fra cui: l'ordine interno di una tupla esposta segue il file (nessun consumatore lo usa; da ordinare o documentare), e il pareggio fra linee gemelle si decide sull'identificativo della rete, che e' identita' del modello. |
| **B — collaudo indipendente del pezzo 1 «Capire»** | Collaudo a contesto separato | **RESPINTO** | 2026-08-07 | Giudicato lo stato committato (`5ae69d4`), worktree isolato, base verde. Esiti distinti. **Istruzioni: respinte con correzioni circoscritte** — l'impianto e' sano (cosa tirare fuori, cosa non inventare, ambiguita' come domande; confine D-104/D-087 rispettato), ma c'e' una **contraddizione interna sul caso reale del quinto impianto** (il §6-B prescrive «il terzo circuito non si disegna», il §4.4 con il §6-A porta a disegnarlo con ripartizioni a T: stesso testo, due grafi entrambi conformi) e **gli esempi ricalcano quasi parola per parola le soluzioni dei testi di prova** (tre assunzioni delle letture manuali citate quasi verbatim), il che compromette ogni prova futura sugli stessi cinque testi. **Verbale della prova: respinto** — le affermazioni centrali («quattro su cinque identici arco per arco», «caricano al primo tentativo») non sono verificabili da nessun artefatto committato: i grafi di camera pulita, le tabelle di rilettura e i rapporti degli agenti non sono agli atti; e «componenti identici» non puo' essere vero alla lettera, perche' le letture manuali hanno sigle e sottosistemi che le istruzioni vietano di scrivere — i criteri del confronto non sono dichiarati. E' la classe di difetto per cui il progetto ha gia' respinto due lavori. **Contratto di consegna: respinto su tre punti** — la tabella a tre classi non copre i casi incontrati (la divergenza 2 e' classificata con una formula che non e' nessuna delle tre; la 4 non ha classe), i campi su cui si giudica l'«identita'» non sono definiti, e il protocollo non impone di conservare le consegne degli agenti. **Letture manuali: verificate intatte** — un solo commit nella storia, rigenerazione byte per byte identica. Il collaudo conferma tutte e sette le correzioni del verbale e ne aggiunge cinque (sciogliere la contraddizione; esempi estranei ai testi di prova o testi nuovi; generalizzare i raccordi a N vie; regola per `project_id`; a CONSEGNA: campi del confronto, conservazione delle consegne, classe mancante). Il giro di correzioni del pezzo 1 riparte da qui, con prova nuova ad agente nuovo e consegne agli atti. |
...
| **E ter — collaudo indipendente delle due correzioni di fine sessione** | Collaudo a contesto separato | **RESPINTE tutte e due** — cinque difetti, il nocciolo regge | 2026-08-07 | Giudicate la camminata del ritorno generale che si apre sui rami e il regime letto dalle potenze (D-108), con criteri scritti dal collaudo prima di leggere il codice e prove proprie piu' dure di quelle di casa: otto rimescolamenti per cinque impianti invece di tre per tre, piu' la rinomina delle tubazioni; il regime dei cinque rifatto da zero sul testo del committente; 900 kW scritti su ogni pezzo senza che nulla si muova. **Il nucleo di entrambe e' confermato** — la camminata si apre davvero sui rami, i cinque impianti non hanno piu' punti aperti, l'ordine del file non decide niente, nessuna regola somma potenze. **I cinque difetti stanno ai bordi, e riguardano cose che le correzioni affermano:** **(1)** sull'ibrido — l'impianto per cui la correzione esiste — il tratto scelto **non porta** l'acqua che la caldaia rimanda dallo scambiatore sanitario, che rientra a valle; per il defangatore, la cui ragione scritta e' «li' passa tutta l'acqua che torna», la posa non regge, e quattro punti aperti sono diventati una posa silenziosa. **(2)** Con un anello sul ritorno il punto lo decide **il nome delle macchine**: a topologia identica, `gen-a`/`gen-b` danno il tratto giusto e `zeta`/`alfa` uno a valle della prima ripartizione — la camminata parte dal primo generatore in ordine alfabetico. **(3)** Il conto del regime **non e' nel modello**: i cinque grafi dichiarano `plant_regime` e nessun componente porta la potenza, mentre le istruzioni dell'interprete ordinano il contrario; chi seguira' le istruzioni produrra' un grafo diverso dal metro che lo misura. **(4)** §4.6 non ha il caso di mezzo — potenza dichiarata solo per alcune macchine: l'impianto 3 ha due macchine che il catalogo dice generatrici e il testo da' la potenza di una sola, la somma e' stata fatta su una e la mancanza non e' detta; l'impianto 4 sta a 34 kW su 35. **(5)** Il documento del committente si contraddice sul regime: la frase vecchia lasciata in piedi accanto alla sezione nuova. **Osservazione non bloccante da portare al PM:** la radice normativa della soglia (Raccolta R, «potenza dei focolari») non copre le pompe di calore, e il registro delle fonti lo dice; il quinto impianto sono tre pompe di calore. Prove in `tests/collaudo/test_collaudo_correzioni_fine_sessione.py` (43 verdi, 11 `xfail` che inchiodano i difetti). Verbale in `docs/collaudi/2026-08-07-correzioni-fine-sessione.md`. **La contraddizione dello schema sul regime, segnalata da due camere pulite, e' stata chiusa in corsa** (`fa7b9e4`). |
| **B quater — la prova nuova in camera pulita e il suo collaudo** | Cinque agenti in camera pulita + collaudo a contesto separato | **giro interrotto** (kit contraddittorio) · **giro 2: RESPINTO** — un difetto solo, non sulla fedelta' | 2026-08-07 | **Il giro interrotto:** due agenti su due, senza vedersi, hanno trovato la stessa contraddizione **dentro il kit** — le istruzioni §4.6 ordinano di ricavare il regime dalle potenze, mentre la descrizione di `PlantRegime` lo dichiarava «mai calcolato» e vietava per esteso proprio la somma che §4.6 prescrive. Testo pre-D-108 sopravvissuto in tre posti. Un kit che si contraddice su una delle quattro cose che l'interprete deve capire non misura le istruzioni: misura quale documento l'agente ha letto per ultimo. Corretto (schema **rigenerato**, non modificato a mano) e prova rifatta da zero con agenti nuovi. Consegne del giro interrotto agli atti, col motivo scritto. **Il giro 2:** cinque agenti freschi, cinque cartelle isolate, i cinque testi originali non modificati (riscontro automatico: le sezioni ricompongono il file byte per byte), ciascuno col solo kit; ognuno ha salvato **prima** il grafo, poi la rilettura, poi il rapporto; nessuna infrazione all'isolamento dichiarata. Consegne agli atti in `skill/capire/prova-2026-08-07/`. **Il collaudo ha RESPINTO su un difetto solo, e la fedelta' e' pulita:** su cinque impianti, 67 componenti e 82 tubazioni, **zero «detto dal testo e perso», zero «inventato»** — le dodici differenze dal metro sono tutte assunzioni tacite della lettura manuale, e su una il metro ha torto (porta una valvola di ritegno che il testo non nomina e che §5 vieta). Regime ricavato 5 su 5, mai chiesto; raccordi N−1 col conto esatto (2, 1, 1, 3, 12); **i tre circuiti secondari del quinto tutti presenti**, nessun collettore assunto; quindici domande in tutto e nessuna chiede un dato che il testo da'. **Il difetto:** il quinto grafo non attraversa il resto della catena — il passo che battezza le linee si ferma, perche' l'agente ha tagliato il lato secondario in quattro reti e tre di esse cominciano su un **raccordo**, mentre le famiglie di linea sanno nominare solo cio' che parte da un generatore o da una riserva. Non e' colpa dell'agente: il grafo e' fedele, coincide arco per arco col metro, e la scelta e' dichiarata. E' un buco delle **istruzioni** — §4.2 dice cos'e' una rete, mai **dove una rete puo' cominciare** — e due camere pulite separate l'hanno segnalato senza vedersi. Prove in `tests/collaudo/test_collaudo_interprete.py` (91 verdi, 1 `xfail`). Verbale in `docs/collaudi/2026-08-07-interprete-giro-2.md`. Correzione applicata a §4.2 e prova rifatta da capo con agenti nuovi, come impone `CONSEGNA.md` §3. |
| **B quinquies — il giro 3 della prova, e il suo collaudo** | Cinque agenti nuovi in camera pulita + collaudo a contesto separato | **APPROVATO** | 2026-08-07 | Corretto il §4.2 — **una rete parte da una macchina che la alimenta o da un confine, mai da un raccordo; i rami che si staccano da una ripartizione restano nella rete da cui nascono** — la prova e' stata rifatta da zero con cinque agenti nuovi. La strada alternativa (estendere `naming/lines.json` con una famiglia per le reti che partono da un raccordo) e' stata scartata: avrebbe autorizzato le reti a moltiplicarsi, che e' una scelta di prodotto, non la chiusura di un buco. **Il collaudo indipendente ha APPROVATO.** Su cinque impianti, 67 componenti e 82 tubazioni: **zero «detto dal testo e perso», zero «inventato»**. Tutti e cinque i grafi attraversano il resto della catena e producono un documento **invariante al rimescolamento** — compreso il quinto, che al giro 2 rompeva la catena. **Il quinto coincide col metro arco per arco e sulle reti con la loro molteplicita'** — il confronto piu' stretto che il contratto ammette, mentre al giro 2 combaciava solo sui fluidi — a meno di una **valvola di ritegno** che la lettura manuale porta sul ricircolo e che il testo non nomina: ferramenta che §5 vieta all'interprete. Classificata «assunzione tacita del metro», e il metro **non e' stato toccato** (criterio 4). Dalla parte opposta: le cinque letture manuali non portano **nemmeno una** proprieta', mentre la camera pulita trascrive tutte le potenze, i volumi e il nome commerciale. **Il rilievo che l'orchestratore aveva girato al collaudo — l'esclusione «non collegato idraulicamente» non dichiarata sul terzo impianto — non era un difetto:** l'agente l'aveva dichiarata scrivendo «non collegat**a**» (la produzione) dove il testo dice «non collegat**o**» (il boiler). Una lettera. La prova cercava la stringa secca ed e' stata corretta a confronto per concordanza, senza ammorbidire il merito — un boiler staccato per distrazione e uno staccato per prescrizione si disegnano identici, e solo la voce dichiarata dice al pezzo che completa di non collegarlo. **I due casi che piu' agenti avevano segnalato senza vedersi non respingono:** la **valvola deviatrice**, che §4.2 non copre alla lettera (ma tutti e tre i grafi che ne hanno una hanno tenuto il ramo nella rete della macchina che lo alimenta, l'hanno dichiarato e combaciano col metro), e il **regime col dato parziale** (impianto 3: il regime ricavato dall'unica potenza scritta e la lacuna dichiarata — le alternative erano buttare via un dato dell'ingegnere o chiedere un dato ricavabile, contro D-108). Istruzioni imprecise, grafi giusti: entrambe le condotte sono ora presidiate da prove. **Un difetto aperto minore, inchiodato:** una voce dichiarata del primo grafo cita due identificativi interni del JSON in una frase destinata all'ingegnere, contro `CONSEGNA.md` §1.2. Non si corregge a mano il grafo di un agente — e' un allegato del verbale — e si chiude alle istruzioni al prossimo giro. Prove in `tests/collaudo/test_collaudo_interprete.py` (147 verdi + 1 marcata). Verbale in `docs/collaudi/2026-08-07-interprete-giro-3-approvato.md`. Consegne in `skill/capire/prova-2026-08-07/`. |
| **I cinque grafi rigenerati dalla pipeline** | Orchestratore | **fatto** | 2026-08-07 | Eseguito `examples/prova/build_test_graphs.py`: regole + assemblatore, nessuna correzione a mano. **Solo il quinto e' cambiato**, e le sei prove rosse che presidiavano l'artefatto vecchio sono verdi. Da 98 a 108 pezzi: **il collettore sparisce** (COL 1→0, il testo non lo nominava), **il pavimento radiante compare** (PAV 0→1) con la sua **miscelatrice** (VM 1→2) e il suo **circolatore** (CIR 3→4), e i **raccordi passano da 8 a 12** — due ripartizioni sulla mandata e due confluenze sul ritorno, la regola generale a N vie al posto di un pezzo mai nominato. Gli altri quattro erano gia' la rigenerazione corrente, byte per byte. Corretto anche il **difetto 5** del collaudo delle correzioni: il documento del confronto non si contraddice piu' sul regime, e il conteggio del quinto e' quello vero. |
