...
| Pacchetto attivo | **`REL-001`** (`ACTIVE_WORK_PACKAGE.md`), **ATTIVO** dal 26 settembre 2026: la skill vera e propria e il PDF. **`REL-003`, i simboli nuovi, è fatto** (I-136, PR #@@) e **`REL-002`, il cartiglio, è fatto** (I-132, PR #59). Poi `REL-004` il DXF, `REL-005` il pacchetto della release |
