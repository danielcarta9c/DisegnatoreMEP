...
| I-018 | 2026-08-10 | **Le valvole di intercettazione per manutenere una macchina vanno molto più vicine ai suoi attacchi.** «Non c'è una regola di vicinanza: andrebbe impostata fissa e piuttosto piccola, esempio 2 mm» | Oggi la distanza da ciò che sta al capo della tratta è fissa a 5 mm, più mezzo simbolo: la valvola nasce a 7,5 mm dall'attacco | **APERTO, e il tentativo è stato fatto e misurato.** Abbassandola a un passo la valvola arriva a 5 mm dall'attacco, ma sull'impianto 1 i rilievi salgono da sei a nove, gli incroci da 13 a 15 e due tratte passano da quattro pieghe a sei: **non è stato tenuto.** La causa è che quella distanza non distingue la valvola che isola una macchina — quella che lui guarda — da un accessorio qualunque in mezzo alla tratta. La regola giusta vale **solo per il primo accessorio contro il proprio componente**, ed è il lavoro che resta |
