...
| I-016 | 2026-08-10 | **Le valvole di ritegno sono disegnate col simbolo sbagliato** | **Verificato, e il riscontro non conferma: sull'impianto 1 non c'è nessuna valvola di ritegno.** Tutti i segni a farfalla che si vedono sono **valvole di intercettazione**, ed è il loro simbolo giusto. Il ritegno è stato rifatto il 9 agosto (I-004) — z coricata con la freccia del flusso — e tutte e tre le voci di catalogo che lo usano puntano a quel segno. **Resta però un fatto che vale come rilievo:** se guardando la tavola lui legge un'intercettazione come un ritegno, i due segni non si distinguono abbastanza a colpo d'occhio | **APERTO, ma da riformulare con lui**: serve che indichi il pezzo, o va trattato come un problema di leggibilità fra i due segni |
