...
3. **Fissare `keep_out`** almeno pari a `A3_LANDSCAPE.min_clearance_mm` sui lati che portano una porta, `0` sugli altri: è lo spazio libero minimo perché una connessione possa raggiungere la porta senza toccare un altro oggetto.
