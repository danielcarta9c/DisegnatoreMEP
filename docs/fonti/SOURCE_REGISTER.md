...
| SRC-027 | [Caleffi — dp 01253/25, valvole di sicurezza per impianti termici e idrosanitari](https://www.caleffi.com/sites/default/files/media/external-file/01253_IT.pdf), 6 pp. | Per il riscaldamento la valvola va sulla sommità del generatore o sulla mandata **più vicino possibile al generatore**; la tubazione di collegamento non deve essere intercettabile. Il senso di montaggio segue la freccia sul corpo | Acquisita e verificata dal PM l'8 settembre 2026 |
