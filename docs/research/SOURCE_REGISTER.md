...
|---|---|---|---|
| CONV-GRAFICA-001 | Forma e geometria di un simbolo singolo: dimensioni in millimetri di carta, porte sul perimetro con faccia coerente, area di rispetto sulle facce con porta, orientamenti tecnicamente ammessi | `docs/GRAPHIC_STANDARD.md` | **Ritirata come fonte di forma il 5 agosto 2026** (D-081, D-082): nessun simbolo pubblicato la cita più — le forme vengono da UNI 9511 (SRC-015/016) e dalla pratica di settore (SRC-008). Restano valide le sole regole *meccaniche* (porte sul perimetro, aree di rispetto), che ora vivono nei vincoli del manifesto. La citano solo le fixture di test |
