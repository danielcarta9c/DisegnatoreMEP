...
- Suite completa: **1106 verdi, 22 parcheggiate, 13 marcate rosse apposta** sui difetti aperti (in 28 minuti, dopo la revisione PM sulle permutazioni); `ruff check src tests examples`: nessun rilievo;
