...
|---|---|---|
| `Cartiglio_NoveC_A3.pdf` | **il cartiglio**, il file sorgente | dato dal PO il 25 settembre 2026: «questo è il cartiglio che usiamo per i fogli A3» (I-127). Sostituisce la versione del primo commit, che resta in Git: stessa geometria, i valori sono diventati segnaposto |
...
Il cartiglio è largo 400 mm: su ogni formato resta a misura, contro l'angolo in basso a destra della squadratura, e l'A4 — 277 mm utili — non lo contiene (D-184). La tavola lo porta quando il comando riceve `--cartiglio assets/cartigli/Cartiglio_NoveC_A3.json`.
